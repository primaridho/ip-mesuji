            ...
            <div class="card-body p-4">
              <div class="c-sidebar-brand d-md-down-none">
                  <a class="c-sidebar-brand-full h4" href="#">
                    <img style="margin-right: 10px;" width="80" height="80" alt="atr" src="<?php echo e(url('img/atr.png')); ?>" >
                  </a>
                <span><h4><?php echo e(trans('panel.site_title')); ?></h4>
                <p><h2><?php echo e(trans('panel.ip')); ?></h2></span>
              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\laragon\www\ip-mesuji\resources\views/auth/login.blade.php ENDPATH**/ ?>