...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.petum.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.peta.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_peta') ? 'is-invalid' : '' }}" type="text" name="no_peta" id="no_peta" value="{{ old('no_peta', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_lembar') ? 'is-invalid' : '' }}" type="text" name="no_lembar" id="no_lembar" value="{{ old('no_lembar', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_peta') ? 'is-invalid' : '' }}" name="status_peta" id="status_peta" required>
                    ...
                    @foreach(App\Petum::STATUS_PETA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_peta', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
